...
namespace smartagridemo
{
    ...
    public partial class Uirregation : Form
    {
        SqlConnection Cn;
        SqlCommand Cmd;
        SqlDataReader dr;
        ...
        {
            S = "select *  from tb_item1 where cname='" + textBox5.Text + "' and cat='Irrigation'";
        ...
        private void Uirregation_Load(object sender, EventArgs e)
        {
